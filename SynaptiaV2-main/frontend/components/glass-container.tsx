...
> = memo(
  ({
    ...
    return (
      <div
        className={cn(
          "relative font-semibold text-white cursor-pointer bg-transparent overflow-hidden transition-all duration-400 rounded-3xl shadow-lg",
          ...
          style={{
            ...
            background: `
              linear-gradient(135deg, 
                rgba(255, 255, 255, ${specularIntensity}) 0%, 
                transparent 20%, 
                transparent 80%, 
                rgba(255, 255, 255, ${specularIntensity * 0.25}) 100%
              )
            `,
          }}
        />
